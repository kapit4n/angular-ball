...
export class MatchApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation teamA.
   *
   ...
   * </em>
   */
  public getTeamA(id: any, refresh: any = {}): Observable<any> {
  ...
  /**
   * Fetches belongsTo relation teamB.
   *
   * @param any id PersistedModel id
   *
   * @param boolean refresh 
   ...
   * </em>
   */
  public getTeamB(id: any, refresh: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/matches/:id/teamB";
    let _routeParams: any = {
